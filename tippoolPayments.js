...
let tipAmtInput =
  document.getElementById("tipAmt");
let paymentForm = document.getElementById(
  "paymentForm"
);

let paymentTbody = document.querySelector(
  "#paymentTable tbody"
);
let summaryTds = document.querySelectorAll(
...
function updateSummary() {
  let tipPercentAvg =
    ...
    Object.keys(allPayments).length;
